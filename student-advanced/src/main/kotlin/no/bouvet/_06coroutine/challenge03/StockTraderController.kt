...
import no.bouvet._06coroutine.challenge03.*
...
class StockTraderController(
     ...
     * Hint 1: re-visit @see [org.course.challenge02.NewsFeedService.sharedFlowTriggeredNewsFeedFlow]. The implementation is almost identical.
     */
